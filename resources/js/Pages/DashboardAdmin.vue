            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        ...
                        <!-- botones -->
                        <div
                            class="flex flex-col /* Por defecto (móvil): los elementos se apilan verticalmente */ sm:flex-row /* A partir de 'sm' (640px): los elementos se disponen en fila */ space-y-4 /* Margen vertical entre elementos para móvil */ sm:space-y-0 /* Elimina el margen vertical en pantallas 'sm' y superiores */ sm:space-x-4 /* Margen horizontal entre elementos para pantallas 'sm' y superiores */"
                        >
                            <Link
                            ...
                            <Link
                                :href="route('reglas.edit')"
                                class="px-4 py-2 bg-indigo-500 text-white font-semibold rounded-lg shadow-md hover:bg-indigo-700"
                            >
