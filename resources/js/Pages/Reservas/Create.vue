...
const getDayColor = (dateStr) => {
    ...
    const availableFutureSlots = possibleSlots.filter(
        (slot) => !isSlotExpired(dateStr, slot)
    );

    if (
        availableFutureSlots.length === 0 ||
        occupiedSlots.length === possibleSlots.length
    ) {
                    ...
                    <div class="p-6 text-gray-900">
                        ...
                        <div class="mb-8 p-4 bg-gray-50 rounded-lg">
                            ...
                            <p class="text-blue-700 text-sm">
                                Selecciona un día disponible y elige tu horario
                                preferido
                            </p>
                        </div>
                        ...
                        <div class="lg:flex lg:space-x-8">
                            ...
                            <div class="w-full lg:w-1/2">
                                ...
                                <div v-if="selectedDate" class="mb-8">
                                        ...
                                        <button
                                            ...
                                            :class="{
                                                'bg-blue-600 text-white border-blue-600 shadow-lg':
                                                    selectedSlot === slot,
                                                'bg-red-100 text-red-600 border-red-300 cursor-not-allowed opacity-50':
                                                    isSlotTaken(slot),
                                    ...
                                    <div
                                        v-else
                                        class="p-6 bg-yellow-50 text-yellow-800 rounded-lg"
                                    >
                                        <div class="flex items-center">
                                ...
                                <div v-if="selectedSlot" class="pt-6">
                                    <div class="mt-6 p-4 bg-gray-50 rounded-lg">
                                        <div class="mb-4">
                                            <h4
                                                class="font-semibold text-blue-900 mb-3"
                                            >
