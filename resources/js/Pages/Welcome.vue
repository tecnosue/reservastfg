    ...
    >
        <div class="relative w-full max-w-4xl px-6 py-10 text-center">
            <div class="flex justify-center mb-8">
                <svg
                    class="h-20 w-auto text-gray-700" 
                    viewBox="0 0 62 65"
                    fill="none"
            ...
            <p class="mt-6 text-xl text-gray-600">
                Gestiona y reserva fácilmente los espacios compartidos de tu comunidad.
            </p>

            <nav v-if="canLogin" class="mt-12 flex flex-1 justify-center gap-4">
                <Link
                ...
                <template v-else>
                    <Link
                        :href="route('login')"
                        class="rounded-lg bg-gray-700 px-6 py-3 text-lg font-semibold text-white shadow-lg transition hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
                    >
                        Iniciar Sesión
                    </Link>
                    ...
                    <Link
                        v-if="canRegister"
                        :href="route('register')"
                        class="rounded-lg border border-gray-700 px-6 py-3 text-lg font-semibold text-gray-700 shadow-lg transition hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
                    >
                        Registrarse
                    </Link>
                </template>
...
/* Puedes añadir estilos específicos aquí si lo necesitas, 
   aunque Tailwind CSS se usa principalmente con clases en el HTML.
   He añadido un gradiente de fondo directamente en el template.
*/
</style>